...
class EvalT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--source_motion', default='./AniMo4D/new_joint_vecs/bairds_tapir_female__animationnotmotionextractedfighting.manisetf92fbaca_bairds_tapir_female_standturnl089_keypoints.json.npy', type=str, help="Source motion path for editing. (new_joint_vecs format .npy file)")
