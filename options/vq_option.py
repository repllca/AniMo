...
def arg_parse(is_train=False):
    ...
    parser.add_argument("--max_text_len", type=int, default=20, help="Maximum length of text description")
    parser.add_argument("--unit_length", type=int, default=4, help="Length of motion")
    ...
    parser.add_argument('--save_every_e', default=5, type=int, help='save model every n epoch')
    ...
    parser.add_argument('--vq_name', type=str, default="rvq", help='Name of this trial')
