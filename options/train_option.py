...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--txt_name', type=str, default='', help='caption path')
        self.parser.add_argument('--max_epoch', type=int, default=500, help='Maximum number of epoch for training')
        self.parser.add_argument('--num_quantizers', type=int, default=6, help='Maximum number of epoch for training')
...
class TrainTexMotMatchOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--suffix', type=str, default="", help='Name of this trial')
