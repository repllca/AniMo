...
class RVQVAE(nn.Module):
    def __init__(self,
        ...
        self.encoder = Encoder(30*128, output_emb_width, down_t, stride_t, width, depth, dilation_growth_rate, activation=activation, norm=norm)
        ...
        self.scale_index= list(range(0, 91)) + list(range(265, 359))
    ...
    def encode(self,species,gender,x):
        N, T, _ = x.shape
        x_in = self.preprocess(x)  
        x_encoder = self.encoder(species,gender,x_in)
